...
class MTSAC(OffPolicyAlgorithm):
    """
    ...
    def _excluded_save_params(self) -> List[str]:
        return super(MTSAC, self)._excluded_save_params() + ["actor", "critic", "critic_target", "log_ent_coef"]
